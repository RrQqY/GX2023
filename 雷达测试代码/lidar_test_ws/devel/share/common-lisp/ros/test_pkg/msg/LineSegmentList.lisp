...
(cl:defclass <LineSegmentList> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (line_segments
    ...
    :type (cl:vector test_pkg-msg:LineSegment)
   :initform (cl:make-array 0 :element-type 'test_pkg-msg:LineSegment :initial-element (cl:make-instance 'test_pkg-msg:LineSegment))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LineSegmentList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LineSegmentList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_pkg-msg:<LineSegmentList> is deprecated: use test_pkg-msg:LineSegmentList instead.")))
...
(cl:defmethod line_segments-val ((m <LineSegmentList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_pkg-msg:line_segments-val is deprecated.  Use test_pkg-msg:line_segments instead.")
  (line_segments m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LineSegmentList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'line_segments)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'test_pkg-msg:LineSegment))
