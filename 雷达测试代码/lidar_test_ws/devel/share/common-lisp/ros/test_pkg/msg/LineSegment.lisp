...
(cl:defmethod cl:initialize-instance :after ((m <LineSegment>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LineSegment)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_pkg-msg:<LineSegment> is deprecated: use test_pkg-msg:LineSegment instead.")))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <LineSegment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_pkg-msg:radius-val is deprecated.  Use test_pkg-msg:radius instead.")
  (radius m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <LineSegment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_pkg-msg:angle-val is deprecated.  Use test_pkg-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'covariance-val :lambda-list '(m))
(cl:defmethod covariance-val ((m <LineSegment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_pkg-msg:covariance-val is deprecated.  Use test_pkg-msg:covariance instead.")
  (covariance m))

(cl:ensure-generic-function 'start-val :lambda-list '(m))
(cl:defmethod start-val ((m <LineSegment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_pkg-msg:start-val is deprecated.  Use test_pkg-msg:start instead.")
  (start m))

(cl:ensure-generic-function 'end-val :lambda-list '(m))
(cl:defmethod end-val ((m <LineSegment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_pkg-msg:end-val is deprecated.  Use test_pkg-msg:end instead.")
  (end m))
