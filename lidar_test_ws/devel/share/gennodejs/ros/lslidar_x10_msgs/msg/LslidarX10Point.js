...
class LslidarX10Point {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LslidarX10Point(null);
  ...
  static datatype() {
    ...
    return 'lslidar_x10_msgs/LslidarX10Point';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LslidarX10Point(null);
...
module.exports = LslidarX10Point;
