...
"""autogenerated by genpy from lslidar_x10_msgs/LslidarX10Scan.msg. Do not edit."""
import codecs
import sys
...
class LslidarX10Scan(genpy.Message):
  _md5sum = "bcd29f667509c681a7820aacabe51d58"
  _type = "lslidar_x10_msgs/LslidarX10Scan"
...
"""
  ...
  _slot_types = ['float64','lslidar_x10_msgs/LslidarX10Point[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LslidarX10Scan, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = lslidar_x10_msgs.msg.LslidarX10Point()
        _x = val1
        start = end
        end += 52
